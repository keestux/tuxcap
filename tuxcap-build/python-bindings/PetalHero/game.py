...
appIni = {	"mCompanyName"		: "Farbs",
		...
		"mProductVersion"	: "1.0",
		"mTitle"			: "Petal Hero (Prototype) v1.0",
		"mRegKey"			: "PtlHero",
		"mWidth"			: 800,
		"mHeight"			: 600,
		"mAutoEnable3D"	: 1,
...
def loadBase():
	...
	Shot.image = PCR.loadImage( "res\\smallShot" )
	canvasImage = PCR.loadImage( "res\\bigcanvas" )
	...
	# load font
	global font
	font = PCR.loadFont( "res\\Fonts\\Andy28Bold.txt" )
