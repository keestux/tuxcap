...
void TextureData::BltTransformed(const Color& theColor, const Rect *theClipRect, float theX, float theY, bool center)
{
    Blt(theColor);
}

void TextureData::BltTransformed(const Rect *theClipRect, float theX, float theY, bool center)
{
    Blt();
}
